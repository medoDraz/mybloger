                    ...
                    @if ($categories->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>@lang('site.posts_count')</th>
                                <th>@lang('site.related_posts')</th>
                            ...
                            @foreach ($categories as $index=>$category)
                                <tr>
                                    ...
                                    <td><a href="{{ route('dashboard.posts.index', ['category_id' => $category->id]) }}" class="btn btn-info btn-sm">@lang('site.related_posts')</a></td>
                                    <td>
