                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">The Post</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="single-post-details-area">
                        ...
                        @if($post->id == $post->id)
                            ...
                            <div class="post-thumbnail mb-50">
                                <img src="{{$post->image_path}}" style="width: 968px; height: 498px;" alt="">
                            </div>
                            ...
                            <div class="post-text">
                                ...
                                <div class="comment_area clearfix">
                                    <h4 class="headline">03 Comments</h4>                                   
                                    <ol>
                                        <!-- Single Comment Area -->
                                        ...
                                        <li class="single_comment_area">
                                            <div class="comment-wrapper d-flex">
                                                <!-- Comment Meta -->
                                                <div class="comment-author">
                                                    <img src="{{ asset('images/blog-img/11.jpg') }}" alt="">
                                                </div>
                                                <!-- Comment Content -->
                                                <div class="comment-content">
                                    ...
                                    <div class="comment-form">
                                        ...
                                        <form action="#" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" class="btn nikki-btn">Send Comment</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
